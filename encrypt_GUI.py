...
class CryptoApp(tk.Tk):
    ...
    def init_ui(self):
        ...
        self.encrypt_button = tk.Button(self, text='Encrypt Text', command=self.encrypt_text)
        self.decrypt_button = tk.Button(self, text='Decrypt Text', command=self.decrypt_text)
        self.encrypt_file_button = tk.Button(self, text='Encrypt File', command=self.encrypt_file)
        self.decrypt_file_button = tk.Button(self, text='Decrypt File', command=self.decrypt_file)
        self.result_display = tk.Text(self, height=10, width=50)
